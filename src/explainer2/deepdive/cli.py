# VENDORED_FROM: nemock/video-explainer-system @ d593aa41dc32d04e3b714b4731b1763f6e31843e (src/explainer/deepdive/cli.py) — copied 2026-06-10; diverges freely (v1 is frozen).
...
def main(argv=None):
    p = argparse.ArgumentParser(prog="explainer2-deepdive", description="Deep-dive long-form orchestrator/assembler.")
