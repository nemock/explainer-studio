# VENDORED_FROM: nemock/video-explainer-system @ d593aa41dc32d04e3b714b4731b1763f6e31843e (src/explainer/deepdive/audio.py) — copied 2026-06-10; diverges freely (v1 is frozen).
#!/usr/bin/env python3
...
CLI:  python -m explainer2.deepdive.audio duck   --vo vo.wav --bed bed.mp3 --out mix.wav [--duck-db 22]
      python -m explainer2.deepdive.audio norm   --in mix.wav --out final.wav [--i -14 --tp -1]
      python -m explainer2.deepdive.audio measure --in clip.wav
      python -m explainer2.deepdive.audio seam   seg1.wav seg2.wav seg3.wav [--max-delta 1.0]
      python -m explainer2.deepdive.audio demo   --vo vo.wav --bed bed.mp3 --outdir /tmp/auddemo
"""
