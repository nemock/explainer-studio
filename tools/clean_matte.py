...
Usage: python tools/clean_matte.py <in.png> <out.png> [--threshold 60] [--erode 2] [--feather 3]
"""
import argparse
...
def clean(src, dst, threshold=60, erode=2, feather=3.0):
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    print(clean(args.src, args.dst, args.threshold, args.erode, args.feather))
